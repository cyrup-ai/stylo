...
impl<Angle, Number, Length, Integer, LengthPercentage> std::fmt::Debug
    for GenericTransformOperation<Angle, Number, Length, Integer, LengthPercentage>
where
    Angle: Zero + std::fmt::Debug,
    Number: PartialEq + std::fmt::Debug,
    Length: std::fmt::Debug,
    Integer: std::fmt::Debug,
    LengthPercentage: Zero + ZeroNoPercent + std::fmt::Debug,
{
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Matrix(m) => f.debug_tuple("Matrix").field(m).finish(),
            Self::Matrix3D(m) => f.debug_tuple("Matrix3D").field(m).finish(),
            Self::Skew(a1, a2) => f.debug_tuple("Skew").field(a1).field(a2).finish(),
            Self::SkewX(a) => f.debug_tuple("SkewX").field(a).finish(),
            Self::SkewY(a) => f.debug_tuple("SkewY").field(a).finish(),
            Self::Translate(x, y) => f.debug_tuple("Translate").field(x).field(y).finish(),
            Self::TranslateX(x) => f.debug_tuple("TranslateX").field(x).finish(),
            Self::TranslateY(y) => f.debug_tuple("TranslateY").field(y).finish(),
            Self::TranslateZ(z) => f.debug_tuple("TranslateZ").field(z).finish(),
            Self::Translate3D(x, y, z) => f
                .debug_tuple("Translate3D")
                .field(x)
                .field(y)
                .field(z)
                .finish(),
            Self::Scale(x, y) => f.debug_tuple("Scale").field(x).field(y).finish(),
            Self::ScaleX(x) => f.debug_tuple("ScaleX").field(x).finish(),
            Self::ScaleY(y) => f.debug_tuple("ScaleY").field(y).finish(),
            Self::ScaleZ(z) => f.debug_tuple("ScaleZ").field(z).finish(),
            Self::Scale3D(x, y, z) => f.debug_tuple("Scale3D").field(x).field(y).field(z).finish(),
            Self::Rotate(a) => f.debug_tuple("Rotate").field(a).finish(),
            Self::RotateX(a) => f.debug_tuple("RotateX").field(a).finish(),
            Self::RotateY(a) => f.debug_tuple("RotateY").field(a).finish(),
            Self::RotateZ(a) => f.debug_tuple("RotateZ").field(a).finish(),
            Self::Rotate3D(x, y, z, a) => f
                .debug_tuple("Rotate3D")
                .field(x)
                .field(y)
                .field(z)
                .field(a)
                .finish(),
            Self::Perspective(p) => f.debug_tuple("Perspective").field(p).finish(),
            Self::InterpolateMatrix { progress, .. } => f
                .debug_struct("InterpolateMatrix")
                .field("from_list", &"<TransformList>")
                .field("to_list", &"<TransformList>")
                .field("progress", progress)
                .finish(),
            Self::AccumulateMatrix { count, .. } => f
                .debug_struct("AccumulateMatrix")
                .field("from_list", &"<TransformList>")
                .field("to_list", &"<TransformList>")
                .field("count", count)
                .finish(),
